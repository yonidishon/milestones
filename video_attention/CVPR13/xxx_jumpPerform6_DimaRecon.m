...
dstFr = xxx_preprocessFrames_DimaRecon(param.videoReader, dstFrIdx, gbvsParam, ofParam, poseletModel, cache);
...
% features
features = xxx_jumpPairwiseFeatures6_DimaRecon(srcFr, srcCands, dstFr, dstCands, options, cache); % v6, cached
