...
mycands_loc = '\\cgm47\D\Dima_Analysis_Milestones\Candidates\MyCandTop5'; 
for i = 1:nv
    iv = videoIdx(i);
    videoName = videos{iv};
...
%     cands = s.cands;
    ...
    filtcands = xxx_filtcands(s_my.mycands,[4]);
    
    cands = xxx_filtcands(s_my.mycands,[5]);
    % load gaze data
