...
visRoot = fullfileCreate(diemDataRoot, 'cvpr13', 'jump_test_v6_full');
visRoot = fullfileCreate(diemDataRoot, 'cvpr13', 'jump_test_v6_no_stat');
% visRoot = fullfileCreate(diemDataRoot, 'cvpr13', 'jump_test_v6_no_mot');
% visRoot = fullfileCreate(diemDataRoot, 'cvpr13', 'jump_test_v6_no_sem');
% visRoot = fullfileCreate(diemDataRoot, 'cvpr13', 'jump_test_v6_no_int');
...
modelFile = fullfile(uncVideoRoot, '00_trained_model_cvpr13_v5_3_no_stat.mat'); % CVPR13, no static
% modelFile = fullfile(uncVideoRoot, '00_trained_model_cvpr13_v5_3_no_mot.mat'); % CVPR13, no motion
% modelFile = fullfile(uncVideoRoot, '00_trained_model_cvpr13_v5_3_no_sem.mat'); % CVPR13, no semantic
% modelFile = fullfile(uncVideoRoot, '00_trained_model_cvpr13_v5_3_no_int.mat'); % CVPR13, no inter-frame
...
cache.featureRoot = fullfileCreate(cache.root, '00_features_v6_1');
...
% testIdx = [14, 34, 48, 53]; % used by Borji, subset

% testSubset = 1:length(testIdx); 
testSubset = [6,9,12,13];
% testSubset = 9;
