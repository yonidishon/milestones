...
exps = {'My','Dima','GBVSPCAM','GBVSPCAS','OFPCAS','OFPCAM'};
...
%% Display results
titles = {'Mean Hit rate','Median Hit rate','Mean Precision','Mean Distance'};

exps_str ={'PCAs+PCAm','GBVS+OF','GBVS+PCAm','GBVS+PCAs','OF+PCAs','OF+PCAm','CVPR2013ALL','CVPR2013GBVS+OF'};
...
for ii =1:length(titles) % run on each measure
    ...
    elseif ii==2
        plot(5,CVPR2013(4),'og','LineWidth',2);
        plot(5,CVPR2013GBVSOF(4),'xy','LineWidth',2);
    elseif ii==3
