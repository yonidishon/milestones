function dstCands = xxx_jumpPerform6Partial(srcCands, srcFrIdx, dstFrIdx, param, options, gbvsParam, ofParam, poseletModel, rf, cache)
...
if isfield(dstFr,'faces') && ~isempty(dstFr.faces) && dstFr.faces(1)==-1
    dstFr.faces=[];
end
dstCands = jumpCandidates3([],[], maps, options);
