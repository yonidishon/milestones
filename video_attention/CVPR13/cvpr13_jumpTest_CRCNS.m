...
visRoot = fullfileCreate(crcnsOrigRoot, 'cvpr13', 'jump_test_v6');
% modelFile = fullfile(uncVideoRoot, '00_trained_model_validation_v5_3.mat'); % validation
modelFile = fullfile(diemDataRoot, 'video_unc', '00_trained_model_cvpr13_v5_3.mat'); % CVPR13
...
testIdx = [5, 11, 18, 21, 26, 28, 31, 33, 34, 38, 45, 47];
...
for i = 1:nt
    ...
    % load jump frames
    [jumpFrames, before, after] = jumpFramesLoad(crcnsOrigRoot, iv, jumpType, 50, 30, videoLen - 30);
