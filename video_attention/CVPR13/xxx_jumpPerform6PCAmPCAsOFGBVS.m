function dstCands = xxx_jumpPerform6PCAmPCAsOFGBVS(vidname, srcCands, srcFrIdx, dstFrIdx, param, options, gbvsParam, ofParam, poseletModel, rf, cache)
...
% features
features = xxx_jumpPairwiseFeatures6PCAmPCAsOFGBVS(srcFr, srcCands, dstFr, dstCands, options, cache); % v6, cached
