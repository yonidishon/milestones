function dstCands = jumpPerform(srcCands, srcFrIdx, dstFrIdx, param, options, gbvsParam, ofParam, poseletModel, rf, cache)
...
% 
% dstCands = jumpPerform(srcCands, srcFrIdx, dstFrIdx, param, options, gbvsParam, ofParam, poseletModel, rf, cache)
% 
% INPUT
...
% preprocess frames
srcFr = preprocessFrames(param.videoReader, srcFrIdx, gbvsParam, ofParam, poseletModel, cache);
% srcFr = []; % v5
...
% features
[features, ~] = jumpPairwiseFeatures5(srcFr, srcCands, dstFr, dstCands, options, cache); % v5, cached
% [features, ~] = jumpPairwiseFeatures2(srcFr, srcCands, dstFr, dstCands, options); % v4
% v2
