function dstCands = xx_jumpPerform6(srcCands, srcFrIdx, dstFrIdx, param, options, gbvsParam, ofParam, poseletModel, rf, cache,bpath,fnms)
...
dstFr = xx_preprocessFrames(param.videoReader, dstFrIdx, gbvsParam, ofParam, poseletModel,bpath,fnms);
