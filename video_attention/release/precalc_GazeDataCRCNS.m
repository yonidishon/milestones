...
% prepalculates all the gaze information for CRCNS data set and puts it in
% cache.
% Define your root of the set via crcnsOrigRoot variable:
% crcnsOrigRoot = <your_crcns_full_path>
